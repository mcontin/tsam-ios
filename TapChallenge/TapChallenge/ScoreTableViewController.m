...
- (void)viewDidLoad {
    ...
    self.scoresArray = [self.delegate scoreTableViewFetchResults];
...
// chiamato ogni volta che bisogna mostrare una cella
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"TableViewCell" forIndexPath:indexPath];
    
    NSString *rowText = [NSString stringWithFormat:@"%@", self.scoresArray[indexPath.row]];
